package com.siaor.poetize.next.res.aop;
...
import com.siaor.poetize.next.res.handle.PoetryLoginException;
    ...
    public Object around(ProceedingJoinPoint joinPoint, LoginCheck loginCheck) throws Throwable {
        ...
        if (flag1) {
            synchronized (userId.intern()) {
                ...
                if (flag2) {
                    PoetryCache.put(token, userPO, CommonConst.TOKEN_EXPIRE);
                    if (token.contains(CommonConst.USER_ACCESS_TOKEN)) {
