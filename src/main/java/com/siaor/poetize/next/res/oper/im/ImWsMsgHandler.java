package com.siaor.poetize.next.res.oper.im;
...
import com.siaor.poetize.next.res.norm.im.ImEnum;
import com.siaor.poetize.next.res.norm.im.ImMessage;
import com.siaor.poetize.next.res.repo.cache.ImMessageCache;
...
public class ImWsMsgHandler implements IWsMsgHandler {
    ...
    @Autowired
    private ImMessageCache imMessageCache;
    ...
    public Object onText(WsRequest wsRequest, String text, ChannelContext channelContext) {
        ...
        try {
            ...
            if (imMessage.getMessageType().intValue() == ImEnum.MESSAGE_TYPE_MSG_SINGLE.getCode()) {
                ...
                imMessageCache.putUserMessage(userMessage);
                ...
                imMessageCache.putGroupMessage(groupMessage);
